    ...
    <div class="page-container">
        ...
        <div class="form-container">
            ...
            <form action="" method="POST">
                ...
                <input type="text" required id="nome_completo" required class="input-field">

                <label for="data_nasc" class="par1">Data de nascimento:</label><br>
                <input type="date" required id="data_nasc" class="input-field">
                ...
                <input type="text" required id="renda_mensal" class="input-field">

                <label for="casa_ou_apt" class="par1">Você mora em casa ou apartamento?</label><br>
                <input type="text" required id="casa_ou_apt" class="input-field">
                ...
                <div class="radio-container">
                    ...
                    <label>
                        <input type="radio" class="radio-btn" requiredname="propriedade" value="alugado"> Alugado
                    </label>
                </div>
                <br>
                <hr>
                ...
                <input type="text" required id="cep" class="input-field">

                <label for="estado" class="par1">Estado:</label><br>
                <select id="estado" required name="estado" class="input-field">
                ...
                <input type="text" required id="cidade" class="input-field">

                <label for="bairro" class="par1">Bairro:</label><br>
                <input type="text" required id="bairro" class="input-field">

                <label for="rua" class="par1">Rua:</label><br>
                <input type="text" required id="rua" class="input-field">

                <label for="numero" class="par1">Número:</label><br>
                <input type="text" required id="numero" class="input-field">

                <label for="ponto_ref" class="par1">Ponto de referência:</label><br>
                <input type="text" required id="ponto_ref" class="input-field">
                <br>
                <hr>
                ...
                <label>
                    <input type="radio" required class="radio-btn" name="cachorro_ou_gato" value="cachorro"> Cachorro
                </label>
                <label>
                    <input type="radio" required class="radio-btn" name="cachorro_ou_gato" value="gato"> Gato
                </label><br><br>

                <label for="nome_animal" class="par1">Qual o nome do animal você tem interesse em adotar:</label><br>
                <input type="text" required id="nome_animal" class="input-field">

                <label for="outros_nimais" class="par1">Você tem outros animais? Se sim, quantos e quais?</label><br>
                <input type="text" required id="outros_nimais" class="input-field">

                <label for="castrados_e_vacinados" class="par1">São castrados e vacinados?</label><br>
                <input type="text" required id="castrados_e_vacinados" class="input-field">
