...
<div class="page-container">
    <div class="form-container">
        ...
        <form action="{{ route('adocao.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <label for="foto_outros_animais" class="par1bold">Se tiver outros animais, foto dos mesmos e das suas carteiras de vacinação</label><br>
            ...
            <label class="par1">Você tem condições físicas, mentais e financeiras de manter um animal?</label><br><br>
            <div class="radio-container">
                <label>
